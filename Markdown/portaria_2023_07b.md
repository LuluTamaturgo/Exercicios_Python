# 🗂️ Descrição da Tabela: portaria_2023_07b
A tabela portaria_2023_07b contém os valores estimados por matrícula para cada modalidade e etapa de ensino, utilizados no cálculo da complementação da União ao Fundeb com base na Portaria Interministerial nº 7/2023 - Anexo B. Os dados estão organizados por tipo de repasse (RP - VAAT e RC - VAAR) e incluem categorias específicas como educação especial, educação profissional, EJA, e formação por alternância. Também são incluídas informações consolidadas como total de matrículas, coeficiente VAAF e estimativa de receita para cada município.

| Campo                                                      | Tipo           | Descrição                                                                 |
| ---------------------------------------------------------- | -------------- | ------------------------------------------------------------------------- |
| `id`                                                       | bigint         | Identificador único da linha na tabela (chave primária, auto\_increment). |
...
| `ens_fund_integral_rp`                                     | decimal(8,2)   | Ensino Fundamental integral - RP.                                         |
...
| `itinerario_formacao_tecnica_prof_rp`                      | decimal(8,2)   | Itinerário de formação técnica/profissional - RP.                         |
...
| `ens_medio_integrado_prof_rc_formacao_alternancia`         | decimal(8,2)   | Ens. Médio integrado profissional com alternância - RC.                   |
...
| `ens_medio_integrado_prof_rc_instituicoes_prof`            | decimal(8,2)   | Ensino Médio integrado prof. em instituições específicas - RC.            |
